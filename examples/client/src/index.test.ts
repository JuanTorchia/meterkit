...
describe("agent resource scope", () => {
  const allowed = parseAllowedResource(
    "https://api.example.com/v1/weather/premium/",
  );
  ...
  it.each([
    ...
    [
      "query string",
      "https://api.example.com/v1/weather/premium?city=Lima",
      true,
    ],
    [
      "malicious prefix",
      "https://api.example.com/v1/weather/premium-evil",
      false,
    ],
    [
      "encoded slash suffix",
      "https://api.example.com/v1/weather/premium%2Fevil",
      false,
    ],
    ...
    [
      "subpath by default",
      "https://api.example.com/v1/weather/premium/hourly",
      false,
    ],
  ...
  it("allows HTTP only for explicit local development", () => {
    expect(
      parseAllowedResource("http://localhost:3402/v1/weather/premium").origin,
