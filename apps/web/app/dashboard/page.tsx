...
const copy = {
  en: {
    ...
    title: "Products, payments and receipts.",
    intro:
      "Before connecting, this workspace shows MeterKit's internal devnet verification—not external users or revenue. Connect to manage only the products and payments owned by your wallet. Signing in is free and does not authorize a payment.",
  },
  es: {
    ...
    title: "Productos, pagos y recibos.",
    intro:
      "Antes de conectar, este panel muestra verificaciones internas de MeterKit en devnet, no usuarios externos ni ingresos. Conecta tu wallet para gestionar únicamente tus productos y pagos. Iniciar sesión es gratis y no autoriza pagos.",
  },
  "pt-BR": {
    ...
    title: "Produtos, pagamentos e recibos.",
    intro:
      "Antes de conectar, este painel mostra verificações internas da MeterKit na devnet, não usuários externos nem receita. Conecte sua carteira para gerenciar somente seus produtos e pagamentos. Entrar é grátis e não autoriza pagamentos.",
  },
} as const;
