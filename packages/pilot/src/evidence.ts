...
const settlementEvidenceInputSchema = z.object({
...
export function validateSettlementEvidence(input: unknown) {
  ...
  return {
    ...
    replay: value.replay,
    notice: "This report proves a sanitized test-network settlement and rejected replay. It contains no signing material or full signature.",
  };
}
